...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = NSURL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyDbxoZGq7Yget6Ml_cHjKA0HdQvT4RB0aY")!
                    ...
                    do { let jsonResult = try NSJSONSerialization.JSONObjectWithData(data, options: NSJSONReadingOptions.MutableContainers) as! NSDictionary
                        ...
                        if jsonResult.count > 0 {
                            if let items = jsonResult["items"] as? NSArray {
                                ...
                                //Delete all objects currently stored in Core data
    ...
    override func numberOfSectionsInTableView(tableView: UITableView) -> Int {
        return 1 //We only want 1 section
    }
